...
### برای اسکن ای پی روی ویندوز فایل [win_warp_ip.zip](https://github.com/Ptechgithub/warp/blob/main/endip/win_warp_ip.zip) دانلود کنید و از حالت فشرده خارج کنید سپس فایل scanner را اجرا کنید. 
---
---
