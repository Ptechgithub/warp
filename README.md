...
### فرمت کانفیگ WARP را برای استفاده در Hiddify اینگونه تنظیم کنید:
warp://license@cleanip:port/?ifp=5-10
### برای دریافت لایسنس وارپ پلاس از این بات تلگرامی ذکر شده در پایین نوشته استفاده کنید.
### با انتخاب 3 یک کانفیگ رایگان WireGuard تولید میشود و به طور خودکار IP سالم  پیدا شده در کانفیگ اضافه میشود.
### هنگام کپی کردن کانفیگ WireGuard و قرار دادن ان در برنامه اگر با خطا مواجه شد. مشکل از نحوه ی کپی شدن و وجود فاصله های اضافی در بین کاراکتر ها میباشد، بهتر است ابتدا در یک فایل ان را قرار بدید(پیست کنید) و فاصله های اضافی را پاک کنید و مجدد با کپی کردن کانفیگ آن را در برنامه های ذکر شده وارد کنید.
