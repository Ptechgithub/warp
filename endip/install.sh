...
show() {
    ...
    echo ""
    echo -e "${yellow}2) ${blue}If you're using ${yellow}IPv6 in ${yellow}V2rayNG, ${blue}place each IP inside${yellow} [ ] ${blue}example: ${yellow}[2606:4700:d0::1836:b925:ebb2:5eb1] ${rest}"
    echo -e "${purple}************************************${rest}"
}
